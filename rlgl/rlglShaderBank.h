...
namespace rlgl{
    ...
    public:
        ...
        static rlgl::ShaderPtr lightMaterialShader();
        static rlgl::ShaderPtr textureLightShader();
        static rlgl::ShaderPtr textureLightMaterialShader();
        static rlgl::ShaderPtr cubeMapShader();
